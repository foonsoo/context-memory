...
def workflow_guide() -> str:
    ...
    return f"""# Shared Context Memory workflow
...
- Record durable user decisions, constraints, verified facts, material test results, procedures, tasks, preferences, and concise summaries as immutable `record_event` evidence. The event kinds eligible for automatic session-end memory proposals are exactly: {kinds}. Other kinds remain valid immutable events but are not automatically promoted.
