...
TOOLS = [
    ...
    {"name":"investigation_record_source","description":"Atomically record one identified source version and consequential evidence, inference, action, decision, rationale, or outcome claims. Inferences always remain proposed.","inputSchema":obj({"investigation_id":{"type":"string"},"source":obj({"source_type":{"type":"string"},"stable_source_id":{"type":"string"},"canonical_uri":{"type":"string"},"source_version":{"type":"string"},"source_updated_at":{"type":"string"},"retrieved_at":{"type":"string"},"section_anchor":{"type":"string"},"access_reason":{"type":"string"},"analysis_method":{"type":"string"},"content_fingerprint":{"type":"string"}},["source_type","stable_source_id","access_reason","analysis_method"]),"claims":{"type":"array","items":obj({"key":{"type":"string"},"role":{"type":"string","enum":["evidence","inference","action","decision","rationale","outcome"]},"title":{"type":"string"},"content":{"type":"string"},"evidence_claim_keys":{"type":"array","items":{"type":"string"}},"memory_type":{"type":"string","enum":["fact","decision","preference","constraint","procedure","summary","task","other"]},"memory_status":{"type":"string","enum":["proposed","active"]},"confidence":{"type":"number","minimum":0,"maximum":1},"importance":{"type":"number","minimum":0,"maximum":1}},["key","role","content"])},"session_id":{"type":"string"},"idempotency_key":{"type":"string"}},["investigation_id","source","claims"]),"annotations":{"readOnlyHint":False}},
