...
TOOLS = [
    ...
    {"name":"checkpoint_create","description":"Idempotently record an explicit interim or final recovery checkpoint, optionally capturing objective Git facts and supplied test results, without mutating Git, memories, or session lifecycle.","inputSchema":obj({"project_id":{"type":"string"},"mode":{"type":"string","enum":["interim","final"]},"reason":{"type":"string","enum":["context_budget","elapsed","material_change","completed","manual"]},"goal":{"type":"string"},"idempotency_key":{"type":"string"},"session_id":{"type":"string"},"scope_id":{"type":"string"},"completed":{"type":"array","items":{"type":"string"}},"next_step":{"type":"string"},"blockers":{"type":"array","items":{"type":"string"}},"source_event_cursor":{"type":"integer","minimum":0},"context_usage":{"type":"number","minimum":0,"maximum":1},"repository_path":{"type":"string"},"test_results":{"type":"array","items":obj({"name":{"type":"string"},"status":{"type":"string","enum":["passed","failed","skipped"]},"command":{"type":"string"},"details":{"type":"string"}},["name","status"])}},["project_id","mode","reason","goal","idempotency_key"]),"annotations":{"readOnlyHint":False}},
    {"name":"checkpoint_evaluate","description":"Evaluate configured context-usage thresholds and client-neutral fallback signals without writing a checkpoint.","inputSchema":obj({"project_id":{"type":"string"},"context_usage":{"type":"number","minimum":0,"maximum":1},"session_id":{"type":"string"},"repository_path":{"type":"string"}},["project_id"]),"annotations":{"readOnlyHint":True}},
    ...
    {"name":"policy_set","description":"Set project operational bounds and checkpoint trigger thresholds.","inputSchema":obj({"project_id":{"type":"string"},"max_context_chars":{"type":"integer","minimum":1000,"maximum":20000},"max_context_items":{"type":"integer","minimum":1,"maximum":50},"audit_keep_entries":{"type":"integer","minimum":100,"maximum":100000},"terminal_memory_days":{"type":"integer","minimum":1,"maximum":3650},"checkpoint_soft_usage":{"type":"number","minimum":0,"maximum":1},"checkpoint_hard_usage":{"type":"number","minimum":0,"maximum":1},"checkpoint_elapsed_seconds":{"type":"integer","minimum":60,"maximum":86400},"checkpoint_event_count":{"type":"integer","minimum":1,"maximum":10000},"checkpoint_max_age_seconds":{"type":"integer","minimum":60,"maximum":604800}},["project_id"]),"annotations":{"readOnlyHint":False}},
