...
TOOLS = [
    ...
    {"name": "get_context", "description": "Select task-relevant memories within a strict character budget; defaults to active/disputed only.", "inputSchema": obj({"project_id":{"type":"string"},"query":{"type":"string"},"char_budget":{"type":"integer","minimum":0,"maximum":100000},"statuses":{"type":"array","items":{"type":"string"}},"scope_id":{"type":"string"}}, ["project_id","query"]), "annotations":{"readOnlyHint":True}},
