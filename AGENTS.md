...
- At the start of every task, use `project_resolve` with the current workspace directory. Use the returned project and scope for all Context Memory operations; never require the user to provide a project UUID.
